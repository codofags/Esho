...
namespace Google.Maps.Examples.Shared
{
    ...
    internal static class ExampleDefaults
    {
        ...
        static ExampleDefaults()
        {
            ...
            /////////materials
            Material wallMaterial = MaterialLibrary.ins.wallMaterial; // new Material(standardShader) { color = new Color(1f, 0.75f, 0.5f) };

            Material roofMaterial = MaterialLibrary.ins.roofMaterial;//new Material(standardShader) { color = new Color(1f, 0.8f, 0.6f) };

            Material regionMaterial = MaterialLibrary.ins.regionMaterial;

            Material waterMaterial = MaterialLibrary.ins.waterMaterial;

            Material segmentMaterial = MaterialLibrary.ins.segmentMaterial;

            Material intersectionMaterial = MaterialLibrary.ins.intersectionMaterial;
